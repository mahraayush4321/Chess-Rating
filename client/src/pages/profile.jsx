            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-4 text-sm">
                <div className="bg-gray-700/50 px-4 py-2 rounded-lg flex items-center">
                  ...
                  <span className="text-white font-medium">{user?.wins || 0}</span>
                ...
                <div className="bg-gray-700/50 px-4 py-2 rounded-lg flex items-center">
                  ...
                  <span className="text-white font-medium">{user?.losses || 0}</span>
                ...
                <div className="bg-gray-700/50 px-4 py-2 rounded-lg flex items-center">
                  ...
                  <span className="text-white font-medium">{user?.draws || 0}</span>
          ...
          <div className="bg-gray-800 rounded-xl p-6 flex-grow shadow-xl border border-gray-700 backdrop-blur-sm bg-opacity-80">
            ...
            {gameHistory.length > 0 ? (
                ...
                <table className="w-full text-gray-300">
                  <thead>
                    <tr className="text-left border-b border-gray-700">
                      <th className="pb-4 px-4 font-medium text-gray-400">Opponent</th>
                      <th className="pb-4 px-4 font-medium text-gray-400">Result</th>
                      <th className="pb-4 px-4 font-medium text-gray-400">Moves</th>
                      <th className="pb-4 px-4 font-medium text-gray-400">Date</th>
                      <th className="pb-4 px-4 font-medium text-gray-400">Duration</th>
                    </tr>
                  </thead>
                  <tbody>
                    {gameHistory.map((game, index) => (
                      <tr 
                        key={game.id} 
                        className={`border-t border-gray-700 hover:bg-gray-700/30 transition-colors ${index % 2 === 0 ? 'bg-gray-800/50' : ''}`}
                      >
                        <td className="py-4 px-4 font-medium text-white">{game.opponent}</td>
                        <td className="py-4 px-4">
                          <span className={`px-2 py-1 rounded text-xs font-medium ${
                            game.result === 'Win' ? 'bg-green-900/30 text-green-400' : 
                            game.result === 'Loss' ? 'bg-red-900/30 text-red-400' : 
              ...
              <div className="py-12 text-center">
                ...
                <h3 className="text-lg text-gray-300 mb-2">No games played yet</h3>
                <p className="text-gray-500 max-w-md mx-auto">Challenge opponents and your game history will appear here</p>
                <button onClick={()=> navigate('/home')} className="mt-4 px-6 py-2 bg-amber-600 hover:bg-amber-700 rounded-lg text-white font-medium transition-colors">
                  Find Opponent
                </button>
              </div>
            )}
            ...
            <div className="space-y-6">
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-white font-bold">{user?.totalMatches || 0}</span>
                </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-white font-bold">
                    {user?.totalMatches ? ((user.wins / user.totalMatches) * 100).toFixed(1) : 0}%
                  </span>
                </div>
                <div className="w-full bg-gray-700 rounded-full h-2">
                  <div 
                    className="bg-green-500 h-2 rounded-full" 
                    style={{ width: `${user?.totalMatches ? (user.wins / user.totalMatches) * 100 : 0}%` }}
                  ></div>
                </div>
              </div>
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-white font-medium transition-colors ${
                  selectedFile ? 'bg-amber-600 hover:bg-amber-700' : 'bg-gray-600 cursor-not-allowed'
                }`}
              >
                Upload
              </button>
